...
export default function HerbalistDashboard() {
  ...
  return (
    <div className="pt-28 pb-16 w-full lg:w-[70%] mx-auto px-4 lg:px-0">
      <h1 className="text-2xl font-bold text-neutral-900 dark:text-white">Herbalist Dashboard</h1>
        ...
        <div className="mt-4 p-4 rounded-xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800">
          <div className="flex items-center gap-4 justify-between">
            ...
            <div className="flex-1">
              <div className="text-sm text-neutral-600 dark:text-neutral-400">Signed in as</div>
              ...
              <div className="text-xs text-neutral-600 dark:text-neutral-400 capitalize">Role: {user?.profile?.user_type || 'herbalist'}</div>
            </div>
            <div>
